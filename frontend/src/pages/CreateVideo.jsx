        ...
        <div className="flex justify-center min-h-screen p-4 sm:p-8 bg-gray-50">
            <div className="w-full max-w-3xl p-6 bg-white rounded-lg shadow-xl md:p-8">
                ...
                <form onSubmit={submit} className="flex flex-col gap-4">
                    ...
                    >
                        [cite_start]{/* Ensure you have at least 6 filter buttons implemented in total [cite: 111] */}
                    ...
                    <div className="flex gap-4 mt-4">
                        <button 
                            ...
                            disabled={loading}
                        >
                            {loading ? "Processing..." : isEditMode ? "Save Changes" : "Upload"}
                        </button>
                        <button 
                            type="button" 
                            onClick={()=>navigate(isEditMode ? `/channel/${form.channelId}` : "/")} 
