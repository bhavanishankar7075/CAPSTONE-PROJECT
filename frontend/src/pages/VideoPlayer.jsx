...
/**
 * VideoPlayer
 * - Improved header action row (Subscribe + Like/Dislike/Share/Download/Clip) matching the provided design
 * - Uses redux actions likeVideo/dislikeVideo + re-fetches video after action to update counts
 * - Shows active state for like/dislike if backend provides an indicator
 *   (supports either video.userReaction === 'like'/'dislike' OR arrays like video.likedBy / video.dislikedBy)
 */
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex items-center gap-4 mt-3">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              {/* Share */}
              <button title="Share" className="flex items-center gap-2 px-3 py-1 text-gray-700 bg-white border rounded-full hover:bg-gray-50" onClick={() => { navigator.clipboard?.writeText(window.location.href); alert("Link copied"); }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              {/* Download */}
              <button title="Download" className="flex items-center gap-2 px-3 py-1 text-gray-700 bg-white border rounded-full hover:bg-gray-50" onClick={() => { /* implement download */ alert("Download not implemented"); }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              {/* Clip */}
              <button title="Clip" className="flex items-center gap-2 px-3 py-1 text-gray-700 bg-white border rounded-full hover:bg-gray-50" onClick={() => alert("Clip not implemented")}>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
